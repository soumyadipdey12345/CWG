  ...
  return (
    <div className="h-[calc(100vh-96px)] overflow-hidden relative">
      <motion.article
        ...
        initial="initial"
        animate="animate"
        className="container max-w-8xl mx-auto h-full xl:h-3/4 flex flex-col gap-4 md:gap-8 items-center justify-center text-center"
      >
        <motion.h2
          variants={textVariants}
...
Complete Web Graphics        </motion.h2>
        <motion.h1
          ...
          style={{width:"100%"}}
        >
We turn your business into a brand.      </motion.h1>
        <motion.div
          variants={textVariants}
      ...
      >
Complete Web Graphics      </motion.div>
